...
public class DBDataSource {
 private String dataBaseName,
         ...
         ;
  public DBDataSource(String dataBaseName0, String user0, String password0, String dBServerName0,String dBPortNo0,String vendorName0) {
  ...
  public  DataSource getDataSource() throws
     RepException {
   ...
   try {
     ...
     if (vendorName.equalsIgnoreCase(Daffodil_ProductName)) {
       if (connectionMode.startsWith("Embedded")) {
         calass = Class.forName("in.co.daffodil.db.jdbc.RmiDaffodilDBDataSource");
         dataSource = (DataSource) (calass.newInstance());
         setDataSrcPropDaffoEmbedded(calass, dataSource, hostName, databaseName, user, password);
       }
       else {
         calass = Class.forName("in.co.daffodil.db.RMI.RMIDaffodilDBDataSource");
         dataSource = (DataSource) (calass.newInstance());
         setDataSrcPropDaffoServer(calass, dataSource, hostName, databaseName,portNo, user, password);
       }

     }
     else if (vendorName.startsWith("M")|| vendorName.startsWith("SQL")) {
       calass = Class.forName("com.microsoft.jdbcx.sqlserver.SQLServerDataSource");
       dataSource = (DataSource) (calass.newInstance());
System.out.println(" dataSource :: "+dataSource.getClass());
       setDataSourceProperties(calass, dataSource, hostName, dataBaseName,portNo, user, password);
     }
       ...
       calass = Class.forName(" org.postgresql.jdbc2.optional.PoolingDataSource");
       dataSource = (DataSource) (calass.newInstance());
       setDataSourceProperties(calass, dataSource, hostName, dataBaseName,portNo, user, password);
     }
 ...
 private  void setDataSourcePropertiesSQlServer(Class calass, DataSource dataSoruce,
                                      String hostName, String dataBaseName,
                                      String user,
                                      String password) throws RepException {
   try {
      // Set  Host Name
      calass.getMethod("setServerName", new Class[] {String.class}).invoke(dataSoruce, new Object[] {hostName});
      // Set the Database Name
      calass.getMethod("setDatabaseName", new Class[] {String.class}).invoke(dataSoruce, new Object[] {dataBaseName});
      // Set user Name
      calass.getMethod("setUser", new Class[] {String.class}).invoke(dataSoruce, new Object[] {user});
      // Set password
      calass.getMethod("setPassword", new Class[] {String.class}).invoke(dataSoruce, new Object[] {password});
   }
...
System.out.println(" setPassword :: "+methodName);
 ...
 private  void setDataSrcPropDaffoServer(Class calass, DataSource dataSoruce,
   ...
   try {
      // Set the HostName
      calass.getMethod("setHostName", new Class[] {String.class}).invoke(dataSoruce, new Object[] {hostName});
      //Set DatabaseName
      calass.getMethod("setDatabaseName", new Class[] {String.class}).invoke(dataSoruce, new Object[] {dataBaseName});
      //Set port Number
      calass.getMethod("setPortNumber", new Class[] {String.class}).invoke(dataSoruce, new Object[] {portNumber});
      //Set user
      calass.getMethod("setUser", new Class[] {String.class}).invoke(dataSoruce, new Object[] {user});
      //Set password
      calass.getMethod("setPassword", new Class[] {String.class}).invoke(dataSoruce, new Object[] {password});
 ...
 try {
   ...
   DBDataSource dbs =  new DBDataSource("dataBaseName0", " user0", "password0", "dBServerName0","dBPortNo0","vendorName0");
   DataSource ds = dbs.getDataSource();

   System.out.println(" User Name  = "+ds.getConnection().getMetaData().getUserName());
